...
__host__	size_t	GenerateInitialVelocities(float4 *pos, float4* vel, float3* colors, const float3 streamVector, uint partPerCell, uint numParticles, uint* geom_hashes, bool mt);
